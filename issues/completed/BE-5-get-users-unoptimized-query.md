...
## Resolution
Replaced User.query.all() with User.query.with_entities() in backend/application/routes/user_routes.py and backend/application/routes/admin/dashboard_routes.py to fetch only the required columns, bypassing full ORM object instantiation.
