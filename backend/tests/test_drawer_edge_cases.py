...
def test_set_drawer_valid(my_logged_in_admin, sample_user):
    res = my_logged_in_admin.post(
        "/api/admin/set_drawer",
        json={"username": sample_user.username, "drawer": "A1B2"},
    )
...
def test_set_drawer_too_long(my_logged_in_admin, sample_user):
    res = my_logged_in_admin.post(
        "/api/admin/set_drawer",
        json={"username": sample_user.username, "drawer": "A1B2C3D4"},
    )
...
def test_set_drawer_non_hex(my_logged_in_admin, sample_user):
    res = my_logged_in_admin.post(
        "/api/admin/set_drawer",
        json={"username": sample_user.username, "drawer": "ZZZZ"},
    )
