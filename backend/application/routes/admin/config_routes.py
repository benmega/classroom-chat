...
@config_bp.route("/toggle-ai", methods=["POST"])
@admin_only
def toggle_ai():
...
@config_bp.route("/toggle-message-sending", methods=["POST"])
@admin_only
...
@config_bp.route("/update_duck_multiplier", methods=["POST"])
...
@config_bp.route("/add-banned-word", methods=["POST"])
@admin_only
def add_banned_word():
