...
class SectionStructure(Structure):
    ...
    ***REMOVED*** + self.get_PointerToRawData_adj()
...
***REMOVED*** = set_bitfields_format(format)
    ...
    ***REMOVED***
    ...
    def __parse__(self, fname, data, fast_load):
        ...
        ***REMOVED***:
                ...
                ***REMOVED***.format(byte, 100.0 * byte_count / len(self.__data__))
            ***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED*** and section.__dict__.get("IMAGE_SCN_MEM_EXECUTE", False):
...
***REMOVED***:
    ...
    ***REMOVED***
        ...
        ***REMOVED***:  # unwind info data structures can be shared among functions
