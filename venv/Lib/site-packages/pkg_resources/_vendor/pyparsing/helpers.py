        ...
        if isinstance(opener, str_type) and isinstance(closer, str_type):
            if len(opener) == 1 and len(closer) == 1:
                if ignoreExpr is not None:
                    ...
                    ***REMOVED***
                ***REMOVED***
            ***REMOVED***.set_parse_action(lambda t: t[0].strip())
                else:
...
def infix_notation(
    ...
    for i, operDef in enumerate(op_list):
        ...
        ***REMOVED*** + Group(lastExpr + OneOrMore(opExpr1 + lastExpr + opExpr2 + lastExpr))
        ...
        ***REMOVED*** + Group(lastExpr + opExpr1 + thisExpr + opExpr2 + thisExpr)
        if pa:
