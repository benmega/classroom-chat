...
def draw_abstract_background(draw, width, height):
    ...
    draw.ellipse(
        [width - 150, -150, width + 150, 150], outline=(255, 255, 255, 15), width=2
    )
    draw.ellipse(
        [width - 250, -250, width + 250, 250], outline=(255, 255, 255, 8), width=1
    )
    draw.ellipse(
        [width - 350, -350, width + 350, 350], outline=(255, 255, 255, 4), width=1
    )
...
def draw_icon(draw, cx, cy, icon_type):
    ...
    if icon_type == "terminal":
        # Draw ">_"
        draw.line(
            [(cx - 40, cy - 30), (cx - 10, cy), (cx - 40, cy + 30)],
            fill=(255, 255, 255, 200),
            width=8,
        )
        draw.line(
            [(cx, cy + 30), (cx + 40, cy + 30)], fill=(255, 255, 255, 200), width=8
        )
    elif icon_type == "cog":
        # Draw gear/cogwheel
        draw.ellipse(
            [cx - 30, cy - 30, cx + 30, cy + 30], outline=(255, 255, 255, 200), width=8
        )
        draw.ellipse(
            [cx - 10, cy - 10, cx + 10, cy + 10], outline=(255, 255, 255, 150), width=4
        )
        for i in range(8):
            angle = i * (math.pi / 4)
        ...
        draw.line(
            [(cx - 35, cy - 10), (cx + 35, cy - 10)], fill=(255, 255, 255, 120), width=4
        )
    elif icon_type == "network":
        # Orbiting nodes
        draw.ellipse(
            [cx - 35, cy - 35, cx + 35, cy + 35], outline=(255, 255, 255, 80), width=2
        )
        # Core
        ...
        draw.line(
            [(cx - 35, cy + 35), (cx + 35, cy - 35)], fill=(255, 255, 255, 200), width=6
        )
        draw.line(
            [(cx + 35, cy + 35), (cx - 35, cy - 35)], fill=(255, 255, 255, 200), width=6
        )
        # Guards
        draw.line(
            [(cx - 25, cy + 15), (cx - 15, cy + 25)], fill=(255, 255, 255, 220), width=8
        )
        draw.line(
            [(cx + 25, cy + 15), (cx + 15, cy + 25)], fill=(255, 255, 255, 220), width=8
        )
        ...
        draw.rounded_rectangle(
            [cx - 45, cy - 25, cx + 45, cy + 25], radius=15, fill=(255, 255, 255, 180)
        )
        # D-pad
        draw.line([(cx - 30, cy), (cx - 14, cy)], fill=(40, 40, 40, 200), width=5)
        draw.line(
            [(cx - 22, cy - 8), (cx - 22, cy + 8)], fill=(40, 40, 40, 200), width=5
        )
        # Buttons
        ...
        # Story book
        draw.polygon(
            [(cx, cy + 30), (cx - 40, cy + 20), (cx - 40, cy - 25), (cx, cy - 15)],
        ...
        # Book pages lines
        draw.line(
            [(cx - 30, cy - 12), (cx - 5, cy - 7)], fill=(80, 80, 80, 100), width=2
        )
        draw.line(
            [(cx - 30, cy + 2), (cx - 5, cy + 7)], fill=(80, 80, 80, 100), width=2
        )
        draw.line(
            [(cx + 30, cy - 12), (cx + 5, cy - 7)], fill=(80, 80, 80, 100), width=2
        )
        ...
        # Wanted Poster
        draw.rectangle(
            [cx - 30, cy - 40, cx + 30, cy + 40], outline=(255, 255, 255, 200), width=4
        )
        ...
        for y_off in [-15, 2, 19]:
            # box
            draw.rectangle(
                [cx - 16, cy + y_off - 5, cx - 6, cy + y_off + 5],
                outline=(255, 255, 255, 200),
                width=2,
            )
            # checkmark line
        ...
        # Gamepad + Stars
        draw.rounded_rectangle(
            [cx - 45, cy - 20, cx + 45, cy + 20], radius=12, fill=(255, 255, 255, 160)
        )
        # D-pad
        draw.line([(cx - 30, cy), (cx - 18, cy)], fill=(40, 40, 40, 200), width=4)
        draw.line(
            [(cx - 24, cy - 6), (cx - 24, cy + 6)], fill=(40, 40, 40, 200), width=4
        )
        # buttons
        ...
        # A pair of dice
        draw.rounded_rectangle(
            [cx - 35, cy - 25, cx - 5, cy + 5],
            radius=6,
            outline=(255, 255, 255, 200),
            width=4,
        )
        draw.rounded_rectangle(
            [cx + 5, cy - 5, cx + 35, cy + 25],
            radius=6,
            outline=(255, 255, 255, 200),
            width=4,
        )
        ...
        # spade
        draw.line(
            [(cx + 15, cy - 30), (cx + 25, cy + 10)], fill=(255, 255, 255, 220), width=5
        )
        draw.polygon(
            [
                (cx + 20, cy - 10),
        ...
        # Node tree structure
        draw.line(
            [(cx, cy - 35), (cx - 25, cy + 5)], fill=(255, 255, 255, 150), width=3
        )
        draw.line(
            [(cx, cy - 35), (cx + 25, cy + 5)], fill=(255, 255, 255, 150), width=3
        )
        draw.line(
            [(cx - 25, cy + 5), (cx - 40, cy + 40)], fill=(255, 255, 255, 150), width=3
        )
        draw.line(
            [(cx - 25, cy + 5), (cx - 10, cy + 40)], fill=(255, 255, 255, 150), width=3
        )
        # Nodes
        ...
        # handles
        draw.ellipse(
            [cx - 32, cy - 28, cx - 15, cy - 12], outline=(255, 215, 0, 230), width=4
        )
        draw.ellipse(
            [cx + 15, cy - 28, cx + 32, cy - 12], outline=(255, 215, 0, 230), width=4
        )
        ...
        draw.chord(
            [cx - 32, cy - 2, cx - 4, cy + 20], 180, 360, fill=(255, 255, 255, 200)
        )
        # Lines representing info
        draw.line(
            [(cx + 2, cy - 10), (cx + 25, cy - 10)], fill=(255, 255, 255, 150), width=3
        )
        draw.line([(cx + 2, cy), (cx + 25, cy)], fill=(255, 255, 255, 150), width=3)
        draw.line(
            [(cx + 2, cy + 10), (cx + 18, cy + 10)], fill=(255, 255, 255, 150), width=3
        )
...
for proj in PROJECTS:
    ...
    try:
        ...
        text_w, text_h = (
            draw.textsize(text, font=font) if hasattr(draw, "textsize") else (200, 20)
        )
