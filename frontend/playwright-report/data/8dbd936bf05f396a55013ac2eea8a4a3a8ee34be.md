...
Call log:
  - waiting for getByTestId('profile-toggle')
    - locator resolved to <button title="Account" aria-haspopup="true" aria-expanded="false" class="profile-toggle" data-testid="profile-toggle">…</button>
  - attempting click action
    - waiting for element to be visible, enabled and stable
  - element was detached from the DOM, retrying
    2 × waiting for" http://localhost:5173/login" navigation to finish...
      - navigated to "http://localhost:5173/login"
    2 × locator resolved to <button title="Account" aria-haspopup="true" aria-expanded="false" class="profile-toggle" data-testid="profile-toggle">…</button>
  - attempting click action
    - waiting for element to be visible, enabled and stable
  - element was detached from the DOM, retrying
