          ...
          <div className="screen-recorder-page">
            <div className="hud-container">
              <div className="layout-preview">
                <div className="corner-target top-left" tabIndex="0" role="button" onClick={() => setSettings({...settings, overlayPosition: 'top-left'})} onKeyDown={(e) => handleKeyDownAction(e, () => setSettings({...settings, overlayPosition: 'top-left'}))} aria-label="Position overlay top-left"></div>
                <div className="corner-target top-right" tabIndex="0" role="button" onClick={() => setSettings({...settings, overlayPosition: 'top-right'})} onKeyDown={(e) => handleKeyDownAction(e, () => setSettings({...settings, overlayPosition: 'top-right'}))} aria-label="Position overlay top-right"></div>
                <div className="corner-target bottom-left" tabIndex="0" role="button" onClick={() => setSettings({...settings, overlayPosition: 'bottom-left'})} onKeyDown={(e) => handleKeyDownAction(e, () => setSettings({...settings, overlayPosition: 'bottom-left'}))} aria-label="Position overlay bottom-left"></div>
                <div className="corner-target bottom-right" tabIndex="0" role="button" onClick={() => setSettings({...settings, overlayPosition: 'bottom-right'})} onKeyDown={(e) => handleKeyDownAction(e, () => setSettings({...settings, overlayPosition: 'bottom-right'}))} aria-label="Position overlay bottom-right"></div>
