...
def test_achievements_page(client, init_db, sample_user, sample_achievement, mock_render_template):
...
def test_achievements_page_with_user_achievements(client, init_db, sample_user, sample_user_achievement, mock_render_template):
...
def test_achievements_page_multiple_types(client, init_db, sample_user, mock_render_template):
    ...
    achievements = [
        ...
        Achievement(name="Course Complete", slug="course-complete", type="certificate", reward=100,
                    description="Complete a course", source="codecombat.com")
    ]
