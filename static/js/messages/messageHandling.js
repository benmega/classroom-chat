...
function updateChatUI(conversationData) {
    ...
    const isScrolledToBottom = chatDiv.scrollHeight - chatDiv.clientHeight <= chatDiv.scrollTop + 1; // Tolerance of 1px
    ...
    // Only autoscroll if they were near the bottom before the update,
    // or if the update was triggered by the user sending a message.
    // The explicit call in sendMessage covers the user-send case.
