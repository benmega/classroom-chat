...
function initProjectInteractions() {
  ...
  document.addEventListener("click", (e) => {
    ...
    if (
      ...
      e.target.closest(".js-close-project-modal")
    ) {
      const modal =
        e.target.closest(".project-modal-overlay") ||
        e.target.closest(".project-modal-content").parentElement;
      if (modal) {
  ...
  document.addEventListener("click", async function (e) {
    if (e.target.classList.contains("remove-skill")) {
      ...
      const skillTag =
        ...
        e.target.closest(".skill-card-visual");
